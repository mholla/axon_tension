...
if __name__ == '__main__':
    ...
    plt.figure()
    plt.plot(growth,total2/total2[0],color=color1,linestyle='solid')
    plt.plot(growth,total1/total1[0],color=color2,linestyle='solid')
    plt.plot(growth,total3/total3[0],color=color3,linestyle='solid')

    plt.legend([ r'$\eta = 4$, $K_{\rm 2} = 25$  \rm  N/m',r'$\eta = 1$, $K_{\rm 2} = 100$  \rm  N/m', r'$\eta = 1/4$, $K_{\rm 2} = 400$  \rm  N/m'])
    ...
    plt.savefig("figure_total_wiring_length_change_eta.png")
    plt.show()